      ...
      <ul className="flex flex-wrap mt-8 justify-start">
        {SkillList.map((item, index) => {
          return (
            <li
              key={index}
              className="font-semibold inline-block capitalize text-2xl py-5 px-12 border-2 border-solid border-black dark:border-white rounded mr-6 mb-6 hover:scale-105 transition-all ease-in-out duration-200 cursor-pointer"
            >
              {item}
            </li>
          );
