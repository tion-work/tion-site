...
export const SunIcon: React.FC<Props> = ({ className, rest }) => {
  return (
    <svg
...
export const MoonIcon: React.FC<Props> = ({ className, rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const LinkedinIcon: React.FC<Props> = ({ className, rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const TwitterIcon: React.FC<Props> = ({ className, rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const GithubIcon: React.FC<Props> = ({ className, rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const DribbbleIcon: React.FC<Props> = ({ className, rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
